...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prune_iterations", nargs="+", type=int, default=[20_000]
    )
    parser.add_argument(
        "--prune_type", type=str, default="opacity"
    )
    parser.add_argument("--prune_percent", type=float, default=0.75) # 0.5
    parser.add_argument("--v_pow", type=float, default=0.1)
    parser.add_argument("--prune_decay", type=float, default=0.6) # 0.8
    ...
    print("\nTraining complete.")
'''
python train_densify_prune.py -s ../gaussian-splatting/data/lobby_row_0.6_mul_move_inpaint_ZITS --eval
'''
